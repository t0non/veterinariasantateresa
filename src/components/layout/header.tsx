    ...
    >
      ...
      <div className="container mx-auto flex h-24 md:h-28 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button asChild className="hidden bg-[#25D366] hover:bg-[#25D366] active:bg-[#25D366] text-white md:flex shadow-md border-none rounded-full px-5 py-2 font-bold">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[300px] bg-background">
                ...
                <nav className="flex h-full flex-col justify-between py-8">
                  ...
                  <Button asChild className="mt-4 w-full bg-[#25D366] hover:bg-[#25D366] active:bg-[#25D366] text-white font-bold rounded-xl py-3 shadow-md border-none">
                    <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer">
                      Falar com Veterinário Agora
                    </a>
                  </Button>
