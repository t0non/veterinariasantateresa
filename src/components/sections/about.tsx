...
export function About() {
  ...
  const [galleryImages] = useState<string[]>(staticGalleryImages);
    ...
    <section id="sobre" className="relative z-40 py-16 sm:py-24 bg-slate-50 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-500 sm:text-4xl font-headline">Referência em Medicina Veterinária em Belo Horizonte</h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Na Veterinária Santa Tereza, acreditamos que todo animal merece o melhor cuidado. Nossa clínica veterinária em BH conta com uma equipe apaixonada e preparada para atender uma grande diversidade de pets com a mesma dedicação e amor.
            </p>
