...
export function WhoWeAre() {
  ...
  return (
    <section id="quem-somos" className="relative py-16 sm:py-24 bg-background overflow-hidden">
      <div className="relative container mx-auto px-4 md:px-6 pb-20" style={{ zIndex: 2 }}>
      ...
      <Image 
        src="https://files.catbox.moe/0885fi.png" 
        alt="Papagaio mascote" 
        width={192}
        height={192}
        className="absolute bottom-0 left-1/2 -translate-x-1/2 w-32 md:w-48 z-0 pointer-events-none"
      />
    </section>
  );
}
