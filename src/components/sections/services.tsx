...
const servicesList = [
    { 
      title: "Consultas Veterinárias em BH", 
    ...
    { 
      title: "Cirurgias Veterinárias Seguras", 
    ...
    <section id="servicos" className="relative z-20 pt-16 pb-24 sm:py-24 bg-gradient-to-b from-[#142850] to-[#0f172a] transition-colors duration-300">
      ...
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div className="text-center mb-12 pt-12">
          <h2 className="text-4xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-yellow-400 to-yellow-600 sm:text-5xl font-headline mb-4 drop-shadow-sm">Serviços da nossa Clínica Veterinária em BH</h2>
          <p className="text-lg text-white max-w-2xl mx-auto">
            Oferecemos consultas, cirurgias, vacinas e exames laboratoriais com a melhor estrutura veterinária de Belo Horizonte.
          </p>
        </div>
            ...
            return (
              ...
              >
                <Image 
                  ...
                  height={150}
                  unoptimized
                  className="pet-image absolute w-28 h-auto object-contain top-0 left-1/2 z-[-1] pointer-events-none opacity-100"
                ...
                <div className="relative z-10 bg-white/95 backdrop-blur-sm p-6 sm:p-8 rounded-3xl shadow-lg hover:shadow-2xl h-full flex flex-col border-b-4 border-transparent hover:border-accent transition-all duration-300">
                  ...
                  <Button 
                    asChild 
                    variant="outline" 
                    className="w-full mt-auto border-primary/10 hover:border-transparent text-sm h-10 sm:h-11 bg-slate-50 hover:bg-[#25D366] hover:text-white transition-all duration-300 text-primary font-medium"
                  >
                    <a 
        ...
        <div className="mt-12 text-center" data-aos="fade-up">
          <Button
            asChild
            size="lg"
            className="rounded-full bg-[#25D366] hover:bg-[#25D366] active:bg-[#25D366] px-8 py-6 text-lg font-bold text-white shadow-xl transition-all border-none ring-0 outline-none focus:ring-0 focus:outline-none whitespace-normal h-auto min-h-[56px]"
          >
